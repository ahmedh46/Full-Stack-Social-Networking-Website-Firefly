<html>
    ...
    <body>
        ...
        <?php
        include("includes/commentheader.php");
        ...
        <form style="padding: 10; " id="comment_form" name="postComment<?php echo $post_id; ?> action="comment_frame.php?post_id=<?php echo $post_id; ?>" method="POST">
              <textarea required style="resize: none;resize: none;width: 85%;height: 45px;border-radius: 5px;color: #000;font-size: 14px;margin: 3px 3px 3px 5px;" name="post_body"></textarea>
            <input id="comment_form_submit" type="submit" name="postComment<?php echo $post_id; ?>" value="Post">
    ...
    while ($comment = mysqli_fetch_array($get_comments)) {
        ...
        ?>  
                <div class="comment_section">
                    ...
                    <span style="float: right;">  <?php echo $time_message . "</span><br>" . $comment_body; ?>
                        <hr>
                        </div>
        <?php
    }//while loop ends
