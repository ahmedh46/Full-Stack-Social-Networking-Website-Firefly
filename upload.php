...
<div class="main_column column">
    ...
    <div id="formExample">
        ...
        <p><b> <?= $msg ?> </b></p>
        <script> document.getElementsByName("image").required = true;</script>
        <form action="upload.php" method="post"  enctype="multipart/form-data">
            <h4>Changing Profile Picture </h4><br /><br />
            <h6> 
                1. Choose your new profile picture by clicking the camera icon. <br>
                2. Click <b><i> Submit </i></b> in order to crop and change your profile picture. </h6> <br> 
            <label for="image">
                <img style='height: 30px; cursor: pointer;'src="assets/icons/camera.jpg"/>
            </label>
            <input type="file" required id="image" style="visibility:hidden;" name="image" style="width:200px; height:30px; " /><br /><br />
            <input id="upload_submit" type="submit" value="Submit" style="width:85px; height:25px;" />
        </form><br /><br />
